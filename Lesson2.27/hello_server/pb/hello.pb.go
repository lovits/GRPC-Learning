...
const file_pb_hello_proto_rawDesc = "" +
	...
	"\x05reply\x18\x01 \x01(\tR\x05reply2\x8e\x02\n" +
	"\aGreeter\x121\n" +
	"\bSayHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00\x12(\n" +
	"\x03Add\x12\x0e.pb.AddRequest\x1a\x0f.pb.AddResponse\"\x00\x126\n" +
	...
	"\tBidiHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse(\x010\x01B\x0fZ\rLesson2.14/pbb\x06proto3"
...
var file_pb_hello_proto_depIdxs = []int32{
	...
	3, // 5: pb.Greeter.SayHello:output_type -> pb.HelloResponse
	2, // 6: pb.Greeter.Add:output_type -> pb.AddResponse
	3, // 7: pb.Greeter.LotsOfReplies:output_type -> pb.HelloResponse
	3, // 8: pb.Greeter.LotsOfGreetings:output_type -> pb.HelloResponse
	3, // 9: pb.Greeter.BidiHello:output_type -> pb.HelloResponse
