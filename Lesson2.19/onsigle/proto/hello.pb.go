...
const file_proto_hello_proto_rawDesc = "" +
	"\n" +
	"\x11proto/hello.proto\x12\x02pt\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"%\n" +
	"\rHelloResponse\x12\x14\n" +
	"\x05reply\x18\x01 \x01(\tR\x05reply2:\n" +
	"\aGreeter\x12/\n" +
	"\bSayHello\x12\x10.pt.HelloRequest\x1a\x11.pt.HelloResponseB\tZ\a./protob\x06proto3"
...
var file_proto_hello_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: pt.HelloRequest
	(*HelloResponse)(nil), // 1: pt.HelloResponse
}
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: pt.Greeter.SayHello:input_type -> pt.HelloRequest
	1, // 1: pt.Greeter.SayHello:output_type -> pt.HelloResponse
