...
const file_helloworld_hello_world_proto_rawDesc = "" +
	"\n" +
	"\x1chelloworld/hello_world.proto\x12\n" +
	...
	"\aGreeter\x12Y\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/example/echoB\x1aZ\x18greeter/proto/helloworldb\x06proto3"

var (
	file_helloworld_hello_world_proto_rawDescOnce sync.Once
	file_helloworld_hello_world_proto_rawDescData []byte
)

func file_helloworld_hello_world_proto_rawDescGZIP() []byte {
	file_helloworld_hello_world_proto_rawDescOnce.Do(func() {
		file_helloworld_hello_world_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_helloworld_hello_world_proto_rawDesc), len(file_helloworld_hello_world_proto_rawDesc)))
	})
...
func file_helloworld_hello_world_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_helloworld_hello_world_proto_rawDesc), len(file_helloworld_hello_world_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
