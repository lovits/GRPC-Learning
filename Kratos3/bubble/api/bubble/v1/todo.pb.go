...
const file_api_bubble_v1_todo_proto_rawDesc = "" +
	...
	"\rListTodoReply\x12'\n" +
	"\x04data\x18\x01 \x03(\v2\x13.api.bubble.v1.todoR\x04data2\xf2\x03\n" +
	"\x04Todo\x12b\n" +
	"\n" +
	"CreateTodo\x12 .api.bubble.v1.CreateTodoRequest\x1a\x1e.api.bubble.v1.CreateTodoReply\"\x12\x82\xd3\xe4\x93\x02\f:\x01*\"\av1/todo\x12g\n" +
	"\n" +
	"UpdateTodo\x12 .api.bubble.v1.UpdateTodoRequest\x1a\x1e.api.bubble.v1.UpdateTodoReply\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\x1a\fv1/todo/{id}\x12d\n" +
	"\n" +
	"DeleteTodo\x12 .api.bubble.v1.DeleteTodoRequest\x1a\x1e.api.bubble.v1.DeleteTodoReply\"\x14\x82\xd3\xe4\x93\x02\x0e*\fv1/todo/{id}\x12[\n" +
	"\aGetTodo\x12\x1d.api.bubble.v1.GetTodoRequest\x1a\x1b.api.bubble.v1.GetTodoReply\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\fv1/todo/{id}\x12Z\n" +
