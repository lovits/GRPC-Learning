...
type Book struct {
	...
	// 引入其他目录的proto
	AuthInfo *author.Info `protobuf:"bytes,3,opt,name=authInfo,proto3" json:"authInfo,omitempty"`
	// 引入官方proto（时间戳）
...
func (x *Book) GetAuthInfo() *author.Info {
	if x != nil {
		return x.AuthInfo
	}
	return nil
...
const file_book_book_proto_rawDesc = "" +
	"\n" +
	"\x0fbook/book.proto\x12\x04book\x1a\x10book/price.proto\x1a\x13author/author.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x99\x01\n" +
	"\x04Book\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12!\n" +
	"\x05price\x18\x02 \x01(\v2\v.book.PriceR\x05price\x12(\n" +
	"\bauthInfo\x18\x03 \x01(\v2\f.author.InfoR\bauthInfo\x12.\n" +
	"\x04date\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x04date2/\n" +
	"\vBookService\x12 \n" +
	"\x06Create\x12\n" +
	".book.Book\x1a\n" +
	".book.BookB\x14Z\x12Pb_demo/proto/bookb\x06proto3"
...
var file_book_book_proto_depIdxs = []int32{
	...
	2, // 1: book.Book.authInfo:type_name -> author.Info
